...
const QMetaObjectExtraData LightWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LightWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_LightWindow,
      qt_meta_data_LightWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LightWindow::getStaticMetaObject() { return staticMetaObject; }
